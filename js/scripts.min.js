...
!function(t, e) {
    ...
    E.extend = E.fn.extend = function() {
        ...
        a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    i = o[e],
                    o !== (n = t[e]) && (u && n && (E.isPlainObject(n) || (r = Array.isArray(n))) ? (s = r ? (r = !1,
                    i && Array.isArray(i) ? i : []) : i && E.isPlainObject(i) ? i : {},
                    o[e] = E.extend(u, s, n)) : void 0 !== n && (o[e] = n));
        return o
    }
    ,
    E.extend({
        ...
        makeArray: function(t, e) {
            var i = e || [];
            return null != t && (w(Object(t)) ? E.merge(i, "string" == typeof t ? [t] : t) : l.call(i, t)),
            i
        },
    ...
    var b = function(i) {
        var t, p, b, s, r, f, h, m, x, l, u, _, C, o, T, g, a, c, v, E = "sizzle" + 1 * new Date, y = i.document, S = 0, n = 0, d = ot(), w = ot(), k = ot(), I = function(t, e) {
            return t === e && (u = !0),
            0
        }, z = {}.hasOwnProperty, e = [], L = e.pop, $ = e.push, j = e.push, A = e.slice, O = function(t, e) {
            for (var i = 0, n = t.length; i < n; i++)
                if (t[i] === e)
                    return i;
            return -1
        }, D = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", P = "[\\x20\\t\\r\\n\\f]", N = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", M = "\\[" + P + "*(" + N + ")(?:" + P + "*([*^$|!~]?=)" + P + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + N + "))|)" + P + "*\\]", q = ":(" + N + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + M + ")*)|.*)\\)|)", H = new RegExp(P + "+","g"), R = new RegExp("^" + P + "+|((?:^|[^\\\\])(?:\\\\.)*)" + P + "+$","g"), F = new RegExp("^" + P + "*," + P + "*"), W = new RegExp("^" + P + "*([>+~]|" + P + ")" + P + "*"), B = new RegExp("=" + P + "*([^\\]'\"]*?)" + P + "*\\]","g"), V = new RegExp(q), U = new RegExp("^" + N + "$"), Q = {
            ID: new RegExp("^#(" + N + ")"),
            CLASS: new RegExp("^\\.(" + N + ")"),
            TAG: new RegExp("^(" + N + "|[*])"),
            ATTR: new RegExp("^" + M),
        ...
        }, Y = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, G = /^[^{]+\{\s*\[native \w/, X = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, K = /[+~]/, J = new RegExp("\\\\([\\da-f]{1,6}" + P + "?|(" + P + ")|.)","ig"), tt = function(t, e, i) {
            var n = "0x" + e - 65536;
        ...
        try {
            j.apply(e = A.call(y.childNodes), y.childNodes),
        ...
        function st(t, e, i, n) {
            var r, s, o, a, l, u, c, h = e && e.ownerDocument, d = e ? e.nodeType : 9;
            if (i = i || [],
            "string" != typeof t || !t || 1 !== d && 9 !== d && 11 !== d)
                return i;
            if (!n && ((e ? e.ownerDocument || e : y) !== C && _(e),
            e = e || C,
            T)) {
                if (11 !== d && (l = X.exec(t)))
                    if (r = l[1]) {
                        if (9 === d) {
                            ...
                            if (o.id === r)
                                return i.push(o),
                                i
                        } else if (h && (o = h.getElementById(r)) && v(e, o) && o.id === r)
                            return i.push(o),
                            i
                    } else {
                        if (l[2])
                        ...
                        if ((r = l[3]) && p.getElementsByClassName && e.getElementsByClassName)
                            return j.apply(i, e.getElementsByClassName(r)),
                            i
                    }
                if (p.qsa && !k[t + " "] && (!g || !g.test(t))) {
                    if (1 !== d)
                        ...
                        for ((a = e.getAttribute("id")) ? a = a.replace(et, it) : e.setAttribute("id", a = E),
                        s = (u = f(t)).length; s--; )
                            u[s] = "#" + a + " " + vt(u[s]);
                        c = u.join(","),
                        h = K.test(t) && mt(e.parentNode) || e
                    }
                    if (c)
                        try {
                            return j.apply(i, h.querySelectorAll(c)),
                            i
                        } catch (t) {} finally {
        ...
        _ = st.setDocument = function(t) {
            ...
            return n !== C && 9 === n.nodeType && n.documentElement && (o = (C = n).documentElement,
            T = !r(C),
            y !== C && (i = C.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", nt, !1) : i.attachEvent && i.attachEvent("onunload", nt)),
            ...
            a = [],
            g = [],
            (p.qsa = G.test(C.querySelectorAll)) && (lt(function(t) {
                o.appendChild(t).innerHTML = "<a id='" + E + "'></a><select id='" + E + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                t.querySelectorAll("[msallowcapture^='']").length && g.push("[*^$]=" + P + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || g.push("\\[" + P + "*(?:value|" + D + ")"),
            ...
            v = e || G.test(o.contains) ? function(t, e) {
            ...
            : function(t, e) {
                ...
                if (!r || !s)
                    return t === C ? -1 : e === C ? 1 : r ? -1 : s ? 1 : l ? O(l, t) - O(l, e) : 0;
                if (r === s)
                    return ct(t, e);
        ...
        st.matchesSelector = function(t, e) {
            ...
            e = e.replace(B, "='$1']"),
            p.matchesSelector && T && !k[e + " "] && (!a || !a.test(e)) && (!g || !g.test(e)))
                try {
                    var i = c.call(t, e);
        ...
        (b = st.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return Q.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && V.test(i) && (e = f(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                    t[2] = i.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(i, n, r) {
                    return function(t) {
                        var e = st.attr(t, i);
                        return null == e ? "!=" === n : !n || (e += "",
                        "=" === n ? e === r : "!=" === n ? e !== r : "^=" === n ? r && 0 === e.indexOf(r) : "*=" === n ? r && -1 < e.indexOf(r) : "$=" === n ? r && e.slice(-r.length) === r : "~=" === n ? -1 < (" " + e.replace(H, " ") + " ").indexOf(r) : "|=" === n && (e === r || e.slice(0, r.length + 1) === r + "-"))
                    }
                },
                CHILD: function(f, t, e, m, g) {
                    ...
                    : function(t, e, i) {
                        var n, r, s, o, a, l, u = v !== y ? "nextSibling" : "previousSibling", c = t.parentNode, h = w && t.nodeName.toLowerCase(), d = !i && !w, p = !1;
                        if (c) {
                            if (v) {
                                for (; u; ) {
                                    for (o = t; o = o[u]; )
                                        if (w ? o.nodeName.toLowerCase() === h : 1 === o.nodeType)
                                            return !1;
                            ...
                            y && d) {
                                for (p = (a = (n = (r = (s = (o = c)[E] || (o[E] = {}))[o.uniqueID] || (s[o.uniqueID] = {}))[f] || [])[0] === S && n[1]) && n[2],
                                o = a && c.childNodes[a]; o = ++a && o && o[u] || (p = a = 0) || l.pop(); )
                                    if (1 === o.nodeType && ++p && o === t) {
                                        r[f] = [S, a, p];
                                        break
                                    }
                            } else if (d && (p = a = (n = (r = (s = (o = t)[E] || (o[E] = {}))[o.uniqueID] || (s[o.uniqueID] = {}))[f] || [])[0] === S && n[1]),
                            !1 === p)
                                for (; (o = ++a && o && o[u] || (p = a = 0) || l.pop()) && ((w ? o.nodeName.toLowerCase() !== h : 1 !== o.nodeType) || !++p || (d && ((r = (s = o[E] || (o[E] = {}))[o.uniqueID] || (s[o.uniqueID] = {}))[f] = [S, p]),
                                o !== t)); )
                                    ;
                ...
                PSEUDO: function(t, s) {
                    ...
                    return o[E] ? o(s) : 1 < o.length ? (e = [t, t, "", s],
                    b.setFilters.hasOwnProperty(t.toLowerCase()) ? at(function(t, e) {
            ...
            pseudos: {
                ...
                lang: at(function(i) {
                    return U.test(i || "") || st.error("unsupported lang: " + i),
        ...
        function yt(a, t, e) {
            ...
            : function(t, e, i) {
                ...
                if (i) {
                    ...
                    for (; t = t[l]; )
                        if (1 === t.nodeType || h)
                            if (r = (s = t[E] || (t[E] = {}))[t.uniqueID] || (s[t.uniqueID] = {}),
                            u && u === t.nodeName.toLowerCase())
                                t = t[l] || t;
                            else {
                                if ((n = r[c]) && n[0] === S && n[1] === d)
                                    return o[2] = n[2];
                                if ((r[c] = o)[2] = a(t, e, i))
                                    return !0
                            }
        ...
        function xt(p, f, m, g, v, t) {
            ...
            v && !v[E] && (v = xt(v, t)),
            at(function(t, e, i, n) {
                var r, s, o, a = [], l = [], u = e.length, c = t || function(t, e, i) {
                    for (var n = 0, r = e.length; n < r; n++)
                        st(t, e[n], i);
                    return i
                }(f || "*", i.nodeType ? [i] : i, []), h = !p || !t && f ? c : bt(c, a, p, i, n), d = m ? v || (t ? p : u || g) ? [] : e : h;
                if (m && m(h, d, i, n),
                g)
                    for (r = bt(d, l),
                    g(r, [], i, n),
                ...
                if (t) {
                    if (v || p) {
                        ...
                        for (s = d.length; s--; )
                            (o = d[s]) && -1 < (r = v ? O(t, o) : a[s]) && (t[r] = !(e[r] = o))
                    }
                } else
                    d = bt(d === e ? d.splice(u, d.length) : d),
        ...
        return gt.prototype = b.filters = b.pseudos,
        b.setFilters = new gt,
        f = st.tokenize = function(t, e) {
            ...
            a = [],
            l = b.preFilter; o; ) {
                for (s in i && !(n = F.exec(o)) || (n && (o = o.slice(n[0].length) || o),
                a.push(r = [])),
                i = !1,
                (n = W.exec(o)) && (i = n.shift(),
                r.push({
                    value: i,
                    type: n[0].replace(R, " ")
                }),
                o = o.slice(i.length)),
                b.filter)
                    !(n = Q[s].exec(o)) || l[s] && !(n = l[s](n)) || (i = n.shift(),
                    r.push({
                        value: i,
                        type: s,
                        matches: n
        ...
        h = st.compile = function(t, e) {
            var i, g, v, y, w, n, r = [], s = [], o = k[t + " "];
            if (!o) {
                for (e || (e = f(t)),
                i = e.length; i--; )
                    (o = _t(e[i]))[E] ? r.push(o) : s.push(o);
                (o = k(t, (g = s,
                y = 0 < (v = r).length,
                w = 0 < g.length,
                n = function(t, e, i, n, r) {
                    var s, o, a, l = 0, u = "0", c = t && [], h = [], d = x, p = t || w && b.find.TAG("*", r), f = S += null == d ? 1 : Math.random() || .1, m = p.length;
                    ...
                    y && u !== l) {
                        ...
                        j.apply(n, h),
                        r && !t && 0 < h.length && 1 < l + v.length && st.uniqueSort(n)
                    }
                    return r && (S = f,
                    x = d),
                    c
        ...
        m = st.select = function(t, e, i, n) {
            var r, s, o, a, l, u = "function" == typeof t && t, c = !n && f(t = u.selector || t);
            if (i = i || [],
            1 === c.length) {
                if (2 < (s = c[0] = c[0].slice(0)).length && "ID" === (o = s[0]).type && 9 === e.nodeType && T && b.relative[s[1].type]) {
                    if (!(e = (b.find.ID(o.matches[0].replace(J, tt), e) || [])[0]))
                        return i;
                    u && (e = e.parentNode),
                    t = t.slice(s.shift().value.length)
                }
                for (r = Q.needsContext.test(t) ? 0 : s.length; r-- && (o = s[r],
                !b.relative[a = o.type]); )
            ...
            return (u || h(t, c))(n, e, !T, i, !e || K.test(t) && mt(e.parentNode) || e),
            i
        }
        ,
    ...
    function L(t, i, n) {
        ...
        }) : z.test(i) ? E.filter(i, t, n) : (i = E.filter(i, t),
        E.grep(t, function(t) {
    ...
    (E.fn.init = function(t, e, i) {
        ...
        "string" != typeof t)
            ...
            this.length = 1,
            this) : E.isFunction(t) ? void 0 !== i.ready ? i.ready(t) : t(E) : E.makeArray(t, this);
        ...
        if (n[1]) {
            ...
            I.test(n[1]) && E.isPlainObject(e))
                for (n in e)
                    E.isFunction(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
            return this
        }
        return (r = T.getElementById(n[2])) && (this[0] = r,
        this.length = 1),
        this
    }
    ).prototype = E.fn,
    ...
    E.fn.extend({
        ...
        closest: function(t, e) {
            var i, n = 0, r = this.length, s = [], o = "string" != typeof t && E(t);
            if (!S.test(t))
                for (; n < r; n++)
    ...
    E.each({
        ...
        E.fn[n] = function(t, e) {
            ...
            1 < this.length && (O[n] || E.uniqueSort(i),
            A.test(n) && i.reverse()),
            this.pushStack(i)
        }
    });
    ...
    E.Callbacks = function(n) {
        ...
        i = {},
        E.each(t.match(P) || [], function(t, e) {
            i[e] = !0
        }),
        i) : E.extend({}, n);
        var r, e, s, o, a = [], l = [], u = -1, c = function() {
            for (o = o || n.once,
            s = r = !0; l.length; u = -1)
    ...
    E.extend({
              ...
              , o = {
                ...
                then: function(e, i, n) {
                            ...
                            var i = this
                              ...
                              , t = function() {
                                ...
                                if (!(r < l)) {
                                    ...
                                    E.isFunction(e) ? a ? e.call(t, u(l, s, N, a), u(l, s, M, a)) : (l++,
                                    e.call(t, u(l, s, N, a), u(l, s, M, a), u(l, s, N, s.notifyWith))) : (o !== N && (i = void 0,
                                    n = [t]),
                                    (a || s.resolveWith)(i, n))
                                }
                            }
                    ...
                    return E.Deferred(function(t) {
                        s[0][3].add(u(0, t, E.isFunction(n) ? n : N, t.notifyWith)),
                        s[1][3].add(u(0, t, E.isFunction(e) ? e : N)),
                        s[2][3].add(u(0, t, E.isFunction(i) ? i : M))
                    }).promise()
                },
                promise: function(t) {
        ...
        when: function(t) {
            ...
            if (i <= 1 && (q(t, s.done(o(e)).resolve, s.reject, !i),
            "pending" === s.state() || E.isFunction(r[e] && r[e].then)))
                return s.then();
            for (; e--; )
                q(r[e], o(e), s.reject);
            return s.promise()
    ...
    E.ready.then = R.then,
    "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? C.setTimeout(E.ready) : (T.addEventListener("DOMContentLoaded", F),
    ...
    E.fn.extend({
        data: function(i, t) {
            ...
            1 === s.nodeType && !U.get(s, "hasDataAttrs"))) {
                for (e = o.length; e--; )
                    o[e] && (0 === (n = o[e].name).indexOf("data-") && (n = E.camelCase(n.slice(5)),
                    G(s, n, r[n])));
    ...
    E.extend({
        queue: function(t, e, i) {
            ...
            if (t)
                return e = (e || "fx") + "queue",
                n = U.get(t, e),
                i && (!n || Array.isArray(i) ? n = U.access(t, e, E.makeArray(i)) : n.push(i)),
                n || []
        },
    ...
    E.fn.extend({
        ...
        promise: function(t, e) {
            var i, n = 1, r = E.Deferred(), s = this, o = this.length, a = function() {
                --n || r.resolveWith(s, [s])
            };
            for ("string" != typeof t && (e = t,
            t = void 0),
            t = t || "fx"; o--; )
                (i = U.get(s[o], t + "queueHooks")) && i.empty && (n++,
                i.empty.add(a));
            return a(),
            r.promise(e)
        }
    ...
    function it(t, e, i, n) {
        ...
        , l = a(), u = i && i[3] || (E.cssNumber[e] ? "" : "px"), c = (E.cssNumber[e] || "px" !== u && +l) && K.exec(E.css(t, e));
        if (c && c[3] !== u)
            for (u = u || c[3],
            i = i || [],
            c = +l || 1; c /= s = s || ".5",
    ...
    function rt(t, e) {
        for (var i, n, r = [], s = 0, o = t.length; s < o; s++)
            ...
            e ? ("none" === i && (r[s] = U.get(n, "display") || null,
            r[s] || (n.style.display = "")),
            "" === n.style.display && tt(n) && (r[s] = (h = u = l = void 0,
            u = (a = n).ownerDocument,
            c = a.nodeName,
            (h = nt[c]) || (l = u.body.appendChild(u.createElement(c)),
            h = E.css(l, "display"),
            l.parentNode.removeChild(l),
            "none" === h && (h = "block"),
            nt[c] = h)))) : "none" !== i && (r[s] = "none",
            U.set(n, "display", i)));
        var a, l, u, c, h;
        for (s = 0; s < o; s++)
    ...
    function ft(t, e, i, n, r) {
        ...
        p = 0; s = d[p++]; )
            if (n && -1 < E.inArray(s, n))
                r && r.push(s);
            else if (u = E.contains(s.ownerDocument, s),
            ...
            if (g && (l = g.events)) {
                for (u = (e = (e || "").match(P) || [""]).length; u--; )
                    ...
                    p) {
                        ...
                        o = s = d.length; s--; )
                            c = d[s],
                            !r && m !== c.origType || i && i.guid !== c.guid || a && !a.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (d.splice(s, 1),
                            c.selector && d.delegateCount--,
                            h.remove && h.remove.call(t, c));
                        o && !d.length && (h.teardown && !1 !== h.teardown.call(t, f, g.handle) || E.removeEvent(t, p, g.handle),
                        delete l[p])
                    } else
                        for (p in l)
                            E.event.remove(t, p + e[u], i, n, !0);
                E.isEmptyObject(l) && U.remove(t, "handle events")
            }
        },
        dispatch: function(t) {
            var e, i, n, r, s, o, a = E.event.fix(t), l = new Array(arguments.length), u = (U.get(this, "events") || {})[a.type] || [], c = E.event.special[a.type] || {};
            for (l[0] = a,
            e = 1; e < arguments.length; e++)
                l[e] = arguments[e];
            if (a.delegateTarget = this,
            !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
                for (o = E.event.handlers.call(this, a, u),
                e = 0; (r = o[e++]) && !a.isPropagationStopped(); )
                    ...
                    i = 0; (s = r.handlers[i++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = s.data,
                        void 0 !== (n = ((E.event.special[s.origType] || {}).handle || s.handler).apply(r.elem, l)) && !1 === (a.result = n) && (a.preventDefault(),
                        a.stopPropagation()));
            ...
            if (l && u.nodeType && !("click" === t.type && 1 <= t.button))
                for (; u !== this; u = u.parentNode || this)
                    if (1 === u.nodeType && ("click" !== t.type || !0 !== u.disabled)) {
                        ...
                        o = {},
                        i = 0; i < l; i++)
                            void 0 === o[r = (n = e[i]).selector + " "] && (o[r] = n.needsContext ? -1 < E(r, this).index(u) : E.find(r, this, null, [u]).length),
                            o[r] && s.push(n);
                        s.length && a.push({
                            elem: u,
                            handlers: s
    ...
    E.Event = function(t, e) {
        ...
        this.type = t.type,
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? wt : bt,
        this.target = t.target && 3 === t.target.nodeType ? t.target.parentNode : t.target,
        this.currentTarget = t.currentTarget,
        this.relatedTarget = t.relatedTarget) : this.type = t,
        e && E.extend(this, e),
        this.timeStamp = t && t.timeStamp || E.now(),
        void (this[E.expando] = !0)) : new E.Event(t,e)
    }
    ,
    E.Event.prototype = {
        constructor: E.Event,
    ...
    function jt(i, n, r, s) {
        n = m.apply([], n);
        var t, e, o, a, l, u, c = 0, h = i.length, d = h - 1, p = n[0], f = E.isFunction(p);
        if (f || 1 < h && "string" == typeof p && !g.checkClone && Et.test(p))
            return i.each(function(t) {
                var e = i.eq(t);
                f && (n[0] = p.call(this, t, e.html())),
                jt(e, n, r, s)
            });
        if (h && (e = (t = ft(n, i[0].ownerDocument, !1, i, s)).firstChild,
        1 === t.childNodes.length && (t = e),
        e || s)) {
            for (a = (o = E.map(ut(t, "script"), zt)).length; c < h; c++)
                l = t,
                c !== d && (l = E.clone(l, !0, !0),
                a && E.merge(o, ut(l, "script"))),
                r.call(i[c], l, c);
            if (a)
                ...
                c = 0; c < a; c++)
                    l = o[c],
                    at.test(l.type || "") && !U.access(l, "globalEval") && E.contains(u, l) && (l.src ? E._evalUrl && E._evalUrl(l.src) : v(l.textContent.replace(kt, ""), u))
        }
        return i
    }
    function At(t, e, i) {
        for (var n, r = e ? E.filter(e, t) : t, s = 0; null != (n = r[s]); s++)
            i || 1 !== n.nodeType || E.cleanData(ut(n)),
            n.parentNode && (i && E.contains(n.ownerDocument, n) && ct(ut(n, "script")),
    ...
    E.extend({
        ...
        clone: function(t, e, i) {
            var n, r, s, o, a, l, u, c = t.cloneNode(!0), h = E.contains(t.ownerDocument, t);
            if (!(g.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || E.isXMLDoc(t)))
                for (o = ut(c),
                n = 0,
                r = (s = ut(t)).length; n < r; n++)
                    a = s[n],
                    l = o[n],
                    void 0,
                    "input" === (u = l.nodeName.toLowerCase()) && st.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
            if (e)
                if (i)
                    for (s = s || ut(t),
                    o = o || ut(c),
                    ...
                    $t(t, c);
            return 0 < (o = ut(c, "script")).length && ct(o, !h && ut(t, "script")),
            c
        },
    ...
    E.fn.extend({
        ...
        empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++)
                1 === t.nodeType && (E.cleanData(ut(t, !1)),
                t.textContent = "");
            return this
        },
        clone: function(t, e) {
        ...
        html: function(t) {
            return W(this, function(t) {
                ...
                if ("string" == typeof t && !Tt.test(t) && !lt[(ot.exec(t) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; i < n; i++)
                            1 === (e = this[i] || {}).nodeType && (E.cleanData(ut(e, !1)),
                            e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
        ...
        replaceWith: function() {
            ...
            return jt(this, arguments, function(t) {
                ...
                E.inArray(this, i) < 0 && (E.cleanData(ut(this)),
    ...
    function Nt(t, e, i) {
        ...
        return (i = i || Pt(t)) && ("" !== (o = i.getPropertyValue(e) || i[e]) || E.contains(t.ownerDocument, t) || (o = E.style(t, e)),
        !g.pixelMarginRight() && Dt.test(o) && Ot.test(e) && (n = a.width,
        r = a.minWidth,
        s = a.maxWidth,
    ...
    !function() {
        ...
        var e, i, n, r, s = T.createElement("div"), o = T.createElement("div");
    ...
    function Qt(t, e, i, n, r) {
        ...
        for (s = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0; s < 4; s += 2)
            "margin" === i && (o += E.css(t, i + J[s], !0, r)),
            n ? ("content" === i && (o -= E.css(t, "padding" + J[s], !0, r)),
            "margin" !== i && (o -= E.css(t, "border" + J[s] + "Width", !0, r))) : (o += E.css(t, "padding" + J[s], !0, r),
            "padding" !== i && (o += E.css(t, "border" + J[s] + "Width", !0, r)));
        return o
    }
    function Yt(t, e, i) {
        var n, r = Pt(t), s = Nt(t, e, r), o = "border-box" === E.css(t, "boxSizing", !1, r);
        return Dt.test(s) ? s : (n = o && (g.boxSizingReliable() || s === t.style[e]),
        "auto" === s && (s = t["offset" + e[0].toUpperCase() + e.slice(1)]),
        (s = parseFloat(s) || 0) + Qt(t, e, i || (o ? "border" : "content"), n, r) + "px")
    }
    ...
    E.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var r, s, o, a = E.camelCase(e), l = Ht.test(e), u = t.style;
                return l || (e = Vt(a)),
                o = E.cssHooks[e] || E.cssHooks[a],
                void 0 === i ? o && "get"in o && void 0 !== (r = o.get(t, !1, n)) ? r : u[e] : ("string" === (s = typeof i) && (r = K.exec(i)) && r[1] && (i = it(t, e, r),
                s = "number"),
                void (null != i && i == i && ("number" === s && (i += r && r[3] || (E.cssNumber[a] ? "" : "px")),
                g.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (u[e] = "inherit"),
                o && "set"in o && void 0 === (i = o.set(t, i, n)) || (l ? u.setProperty(e, i) : u[e] = i))))
            }
        },
        css: function(t, e, i, n) {
            var r, s, o, a = E.camelCase(e);
            return Ht.test(e) || (e = Vt(a)),
    ...
    E.each(["height", "width"], function(t, o) {
        E.cssHooks[o] = {
            get: function(t, e, i) {
                if (e)
                    return !qt.test(E.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Yt(t, o, i) : et(t, Rt, function() {
                        return Yt(t, o, i)
                    })
            },
            set: function(t, e, i) {
                var n, r = i && Pt(t), s = i && Qt(t, o, i, "border-box" === E.css(t, "boxSizing", !1, r), r);
                return s && (n = K.exec(e)) && "px" !== (n[3] || "px") && (t.style[o] = e,
                e = E.css(t, o)),
                Ut(0, e, s)
            }
        }
    ...
    E.cssHooks.marginLeft = Mt(g.reliableMarginLeft, function(t, e) {
        if (e)
            return (parseFloat(Nt(t, "marginLeft")) || t.getBoundingClientRect().left - et(t, {
                marginLeft: 0
            }, function() {
    ...
    E.fx = Zt.prototype.init,
    E.fx.step = {};
    var Gt, Xt, Kt, Jt, te = /^(?:toggle|show|hide)$/, ee = /queueHooks$/;
    function ie() {
        Xt && (!1 === T.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(ie) : C.setTimeout(ie, E.fx.interval),
        E.fx.tick())
    }
    function ne() {
    ...
    function oe(s, t, e) {
        var i, o, n = 0, r = oe.prefilters.length, a = E.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (o)
                return !1;
            for (var t = Gt || ne(), e = Math.max(0, u.startTime + u.duration - t), i = 1 - (e / u.duration || 0), n = 0, r = u.tweens.length; n < r; n++)
                u.tweens[n].run(i);
            return a.notifyWith(s, [u, i, e]),
            i < 1 && r ? e : (r || a.notifyWith(s, [u, 1, 0]),
            a.resolveWith(s, [u]),
            !1)
        }, u = a.promise({
            elem: s,
            ...
            stop: function(t) {
                ...
                for (o = !0; e < i; e++)
                    u.tweens[e].run(1);
                return t ? (a.notifyWith(s, [u, 1, 0]),
                a.resolveWith(s, [u, t])) : a.rejectWith(s, [u, t]),
                this
            }
        }), c = u.props;
        for (function(t, e) {
            ...
            if (i = oe.prefilters[n].call(u, s, c, u.opts))
                return E.isFunction(i.stop) && (E._queueHooks(u.elem, u.opts.queue).stop = E.proxy(i.stop, i)),
                i;
        return E.map(c, se, u),
        E.isFunction(u.opts.start) && u.opts.start.call(s, u),
    ...
    E.Animation = E.extend(oe, {
        tweeners: {
            "*": [function(t, e) {
                ...
                return it(i.elem, t, K.exec(e), i),
                i
            }
            ]
        },
        tweener: function(t, e) {
            for (var i, n = 0, r = (t = E.isFunction(t) ? (e = t,
            ["*"]) : t.match(P)).length; n < r; n++)
                i = t[n],
                oe.tweeners[i] = oe.tweeners[i] || [],
                oe.tweeners[i].unshift(e)
        },
        prefilters: [function(t, e, i) {
            var n, r, s, o, a, l, u, c, h = "width"in e || "height"in e, d = this, p = {}, f = t.style, m = t.nodeType && tt(t), g = U.get(t, "fxshow");
            for (n in i.queue || (null == (o = E._queueHooks(t, "fx")).unqueued && (o.unqueued = 0,
            a = o.empty.fire,
            ...
            if ((l = !E.isEmptyObject(e)) || !E.isEmptyObject(p))
                ...
                null == (u = g && g.display) && (u = U.get(t, "display")),
                "none" === (c = E.css(t, "display")) && (u ? c = u : (rt([t], !0),
                u = t.style.display || u,
                c = E.css(t, "display"),
                rt([t]))),
    ...
    E.fn.extend({
        ...
        stop: function(r, t, s) {
            ...
            this.each(function() {
                ...
                if (e)
                    ...
                    for (e in n)
                        n[e] && n[e].stop && ee.test(e) && o(n[e]);
                for (e = i.length; e--; )
                    i[e].elem !== this || null != r && i[e].queue !== r || (i[e].anim.stop(s),
                    t = !1,
                    i.splice(e, 1));
        ...
        finish: function(o) {
            return !1 !== o && (o = o || "fx"),
            this.each(function() {
                var t, e = U.get(this), i = e[o + "queue"], n = e[o + "queueHooks"], r = E.timers, s = i ? i.length : 0;
                for (e.finish = !0,
                E.queue(this, o, []),
                n && n.stop && n.stop.call(this, !0),
                t = r.length; t--; )
                    r[t].elem === this && r[t].queue === o && (r[t].anim.stop(!0),
                    r.splice(t, 1));
                for (t = 0; t < s; t++)
    ...
    E.extend({
        attr: function(t, e, i) {
            ...
            if (3 !== s && 8 !== s && 2 !== s)
                return void 0 === t.getAttribute ? E.prop(t, e, i) : (1 === s && E.isXMLDoc(t) || (r = E.attrHooks[e.toLowerCase()] || (E.expr.match.bool.test(e) ? ae : void 0)),
                void 0 !== i ? null === i ? void E.removeAttr(t, e) : r && "set"in r && void 0 !== (n = r.set(t, i, e)) ? n : (t.setAttribute(e, i + ""),
                i) : r && "get"in r && null !== (n = r.get(t, e)) ? n : null == (n = E.find.attr(t, e)) ? void 0 : n)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
    ...
    E.fn.extend({
        ...
        toggleClass: function(r, e) {
            ...
            return "boolean" == typeof e && "string" === s ? e ? this.addClass(r) : this.removeClass(r) : E.isFunction(r) ? this.each(function(t) {
                ...
                if ("string" === s)
                    ...
                    void 0 !== r && "boolean" !== s || ((t = de(this)) && U.set(this, "__className__", t),
        ...
        hasClass: function(t) {
            var e, i, n = 0;
            for (e = " " + t + " "; i = this[n++]; )
                if (1 === i.nodeType && -1 < (" " + he(de(i)) + " ").indexOf(e))
                    return !0;
            return !1
        }
    });
    ...
    E.fn.extend({
        val: function(i) {
            var n, t, r, e = this[0];
            return arguments.length ? (r = E.isFunction(i),
    ...
    E.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var i, n, r = t.options, s = E.makeArray(e), o = r.length; o--; )
    ...
    E.extend(E.event, {
        trigger: function(t, e, i, n) {
            var r, s, o, a, l, u, c, h = [i || T], d = f.call(t, "type") ? t.type : t, p = f.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = o = i = i || T,
            3 !== i.nodeType && 8 !== i.nodeType && !fe.test(d + E.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(),
            p.sort()),
            l = d.indexOf(":") < 0 && "on" + d,
            ...
            n || !c.trigger || !1 !== c.trigger.apply(i, e))) {
                if (!n && !c.noBubble && !E.isWindow(i)) {
                    ...
                    fe.test(a + d) || (s = s.parentNode); s; s = s.parentNode)
                        h.push(s),
                        o = s;
                ...
                for (r = 0; (s = h[r++]) && !t.isPropagationStopped(); )
                    ...
                    (u = (U.get(s, "events") || {})[t.type] && U.get(s, "handle")) && u.apply(s, e),
                    (u = l && s[l]) && u.apply && B(s) && (t.result = u.apply(s, e),
                    !1 === t.result && t.preventDefault());
                return t.type = d,
                n || t.isDefaultPrevented() || c._default && !1 !== c._default.apply(h.pop(), e) || !B(i) || l && E.isFunction(i[d]) && !E.isWindow(i) && ((o = i[l]) && (i[l] = null),
                i[E.event.triggered = d](),
    ...
    g.focusin || E.each({
        ...
        E.event.special[n] = {
            ...
            teardown: function() {
                var t = this.ownerDocument || this
                  , e = U.access(t, n) - 1;
                e ? U.access(t, n, e) : (t.removeEventListener(i, r, !0),
                U.remove(t, n))
            }
        }
    });
    ...
    function Ae(s) {
        return function(t, e) {
            "string" != typeof t && (e = t,
            t = "*");
            var i, n = 0, r = t.toLowerCase().match(P) || [];
            if (E.isFunction(e))
                for (; i = r[n++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    E.extend({
        ...
        ajax: function(t, e) {
            ...
            t = void 0),
            e = e || {};
            var c, h, d, i, p, n, f, m, r, s, g = E.ajaxSetup({}, e), v = g.context || g, y = g.context && (v.nodeType || v.jquery) ? E(v) : E.event, w = E.Deferred(), b = E.Callbacks("once memory"), x = g.statusCode || {}, o = {}, a = {}, l = "canceled", _ = {
                readyState: 0,
            ...
            if (w.promise(_),
            g.url = ((t || g.url || me.href) + "").replace(Ie, me.protocol + "//"),
            ...
            h = g.url.replace(Te, ""),
            g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(Ce, "+")) : (s = g.url.slice(h.length),
            g.data && (h += (ve.test(h) ? "&" : "?") + g.data,
            delete g.data),
            !1 === g.cache && (h = h.replace(Ee, "$1"),
            s = (ve.test(h) ? "&" : "?") + "_=" + ge++ + s),
            g.url = h + s),
            ...
            _.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + $e + "; q=0.01" : "") : g.accepts["*"]),
            g.headers)
                _.setRequestHeader(r, g.headers[r]);
            if (g.beforeSend && (!1 === g.beforeSend.call(v, _, g) || f))
                return _.abort();
            if (l = "abort",
            b.add(g.complete),
            _.done(g.success),
            ...
            function u(t, e, i, n) {
                ...
                r ? (g.ifModified && ((l = _.getResponseHeader("Last-Modified")) && (E.lastModified[h] = l),
                ...
                _.status = t,
                _.statusText = (e || u) + "",
                r ? w.resolveWith(v, [s, u, _]) : w.rejectWith(v, [_, u, o]),
                _.statusCode(x),
                x = void 0,
                m && y.trigger(r ? "ajaxSuccess" : "ajaxError", [_, g, r ? s : o]),
                b.fireWith(v, [_, u]),
    ...
    E.fn.extend({
        wrapAll: function(t) {
            var e;
            return this[0] && (E.isFunction(t) && (t = t.call(this[0])),
        ...
        if (g.cors || Ne && !r.crossDomain)
            return {
                send: function(t, e) {
                    ...
                    s = function(t) {
                        return function() {
                            s && (s = o = n.onload = n.onerror = n.onabort = n.onreadystatechange = null,
                            "abort" === t ? n.abort() : "error" === t ? "number" != typeof n.status ? e(0, "error") : e(n.status, n.statusText) : e(Pe[n.status] || n.status, n.statusText, "text" !== (n.responseType || "text") || "string" != typeof n.responseText ? {
                                binary: n.response
                            } : {
                                text: n.responseText
    ...
    E.ajaxPrefilter("json jsonp", function(t, e, i) {
        ...
        if (o || "jsonp" === t.dataTypes[0])
            return n = t.jsonpCallback = E.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
            o ? t[o] = t[o].replace(He, "$1" + n) : !1 !== t.jsonp && (t.url += (ve.test(t.url) ? "&" : "?") + t.jsonp + "=" + n),
            ...
            ,
            i.always(function() {
                void 0 === r ? E(C).removeProp(n) : C[n] = r,
                t[n] && (t.jsonpCallback = e.jsonpCallback,
                qe.push(n)),
                s && E.isFunction(r) && r(s[0]),
                s = r = void 0
            }),
            "script"
    }),
    g.createHTMLDocument = ((Me = T.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    E.parseHTML = function(t, e, i) {
        ...
        s = !i && [],
        (r = I.exec(t)) ? [e.createElement(r[1])] : (r = ft([t], e, s),
    ...
    E.offset = {
        setOffset: function(t, e, i) {
            var n, r, s, o, a, l, u = E.css(t, "position"), c = E(t), h = {};
            "static" === u && (t.style.position = "relative"),
            a = c.offset(),
            s = E.css(t, "top"),
            l = E.css(t, "left"),
            r = ("absolute" === u || "fixed" === u) && -1 < (s + l).indexOf("auto") ? (o = (n = c.position()).top,
            n.left) : (o = parseFloat(s) || 0,
            parseFloat(l) || 0),
            E.isFunction(e) && (e = e.call(t, i, E.extend({}, a))),
    ...
    E.fn.extend({
        ...
        position: function() {
            if (this[0]) {
                ...
                return "fixed" === E.css(i, "position") ? e = i.getBoundingClientRect() : (t = this.offsetParent(),
                e = this.offset(),
                k(t[0], "html") || (n = t.offset()),
                n = {
    ...
    E.each({
        ...
        E.fn[e] = function(t) {
            return W(this, function(t, e, i) {
                var n;
                return E.isWindow(t) ? n = t : 9 === t.nodeType && (n = t.defaultView),
                void 0 === i ? n ? n[r] : t[e] : void (n ? n.scrollTo(s ? n.pageXOffset : i, s ? i : n.pageYOffset) : t[e] = i)
    ...
    E.each({
        ...
        E.each({
            ...
            E.fn[s] = function(t, e) {
                ...
                return W(this, function(t, e, i) {
                    var n;
                    return E.isWindow(t) ? 0 === s.indexOf("outer") ? t["inner" + o] : t.document.documentElement["client" + o] : 9 === t.nodeType ? (n = t.documentElement,
                    Math.max(t.body["scroll" + o], n["scroll" + o], t.body["offset" + o], n["offset" + o], n["client" + o])) : void 0 === i ? E.css(t, e, r) : E.style(t, e, i, r)
                }, a, i ? t : void 0, i)
            }
        })
    }),
...
function(t) {
    ...
    c.extend(c.fn, {
        validate: function(t) {
            if (this.length) {
                ...
                this.on("submit.validate", function(i) {
                    function t() {
                        var t, e;
                        return n.submitButton && (n.settings.submitHandler || n.formSubmitted) && (t = c("<input type='hidden'/>").attr("name", n.submitButton.name).val(c(n.submitButton).val()).appendTo(n.currentForm)),
                        !n.settings.submitHandler || (e = n.settings.submitHandler.call(n, n.currentForm, i),
                        t && t.remove(),
                        void 0 !== e && e)
                    }
        ...
        valid: function() {
            var t, e, i;
            return c(this[0]).is("form") ? t = this.validate().form() : (i = [],
            t = !0,
    ...
    c.validator.format = function(i, t) {
        ...
        : (void 0 === t || (2 < arguments.length && t.constructor !== Array && (t = c.makeArray(arguments).slice(1)),
    ...
    c.extend(c.validator, {
        ...
        prototype: {
            ...
            element: function(t) {
                var e, i, n = this.clean(t), r = this.validationTargetFor(n), s = this, o = !0;
                return void 0 === r ? delete this.invalid[n.name] : (this.prepareElement(r),
                this.currentElements = c(r),
                (i = this.groups[r.name]) && c.each(this.groups, function(t, e) {
            ...
            elements: function() {
                ...
                return c(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function() {
                    ...
                    this.name = t),
                    !(t in i || !e.objectLength(c(this).rules())) && (i[t] = !0)
                })
            },
            clean: function(t) {
                return c(t)[0]
            ...
            elementValue: function(t) {
                ...
                return "radio" === r || "checkbox" === r ? this.findByName(t.name).filter(":checked").val() : "number" === r && void 0 !== t.validity ? t.validity.badInput ? "NaN" : n.val() : (e = t.hasAttribute("contenteditable") ? n.text() : n.val(),
                "file" === r ? "C:\\fakepath\\" === e.substr(0, 12) ? e.substr(12) : 0 <= (i = e.lastIndexOf("/")) ? e.substr(i + 1) : 0 <= (i = e.lastIndexOf("\\")) ? e.substr(i + 1) : e : "string" == typeof e ? e.replace(/\r/g, "") : e)
            },
            check: function(e) {
                e = this.validationTargetFor(this.clean(e));
                var t, i, n, r, s = c(e).rules(), o = c.map(s, function(t, e) {
                    return e
                }).length, a = !1, l = this.elementValue(e);
                if ("function" == typeof s.normalizer ? r = s.normalizer : "function" == typeof this.settings.normalizer && (r = this.settings.normalizer),
                r) {
                    if ("string" != typeof (l = r.call(e, l)))
            ...
            defaultMessage: function(t, e) {
                ...
                var i = this.findDefined(this.customMessage(t.name, e.method), this.customDataMessage(t, e.method), !this.settings.ignoreTitle && t.title || void 0, c.validator.messages[e.method], "<strong>Warning: No message defined for " + t.name + "</strong>")
                  , n = /\$?\{(\d+)\}/g;
                return "function" == typeof i ? i = i.call(this, e.parameters, t) : n.test(i) && (i = c.validator.format(i.replace(n, "{$1}"), e.parameters)),
                i
            },
            ...
            showLabel: function(t, e) {
                var i, n, r, s, o = this.errorsFor(t), a = this.idOrName(t), l = c(t).attr("aria-describedby");
                o.length ? (o.removeClass(this.settings.validClass).addClass(this.settings.errorClass),
                o.html(e)) : (i = o = c("<" + this.settings.errorElement + ">").attr("id", a + "-error").addClass(this.settings.errorClass).html(e || ""),
                this.settings.wrapper && (i = o.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()),
                this.labelContainer.length ? this.labelContainer.append(i) : this.settings.errorPlacement ? this.settings.errorPlacement.call(this, i, c(t)) : i.insertAfter(t),
        ...
        attributeRules: function(t) {
            var e, i, n = {}, r = c(t), s = t.getAttribute("type");
            ...
            return c.each(n, function(t, e) {
                if (!1 !== e) {
                    if (e.param || e.depends) {
                        ...
                        i ? n[t] = void 0 === e.param || e.param : (c.data(r.form, "validator").resetElements(c(r)),
                        delete n[t])
                    }
                } else
                    delete n[t]
        ...
        methods: {
            ...
            step: function(t, e, i) {
                var n, r = c(e).attr("type"), s = "Step attribute on input type " + r + " is not supported.", o = new RegExp("\\b" + r + "\\b"), a = function(t) {
                    var e = ("" + t).match(/(?:\.(\d+))?$/);
            ...
            remote: function(s, o, t, a) {
                ...
                c.ajax(c.extend(!0, {
                    ...
                    success: function(t) {
                        ...
                        l.invalid[o.name] = !1,
                        l.showErrors()) : (e = {},
                        i = t || l.defaultMessage(o, {
                            method: a,
                            parameters: s
                        }),
                        e[o.name] = u.message = i,
                        l.invalid[o.name] = !0,
                        l.showErrors(e)),
                        u.valid = r,
                        l.stopRequest(o, r)
...
function(t) {
    ...
    var h, n, d, r, p, e, l = "Close", u = "BeforeClose", f = "MarkupParse", m = "Open", g = ".mfp", v = "mfp-ready", i = "mfp-removing", o = "mfp-prevent-close", t = function() {}, a = !!window.jQuery, y = c(window), w = function(t, e) {
        h.ev.on("mfp" + t + g, e)
    }, b = function(t, e, i, n) {
        var r = document.createElement("div");
        return r.className = "mfp-" + t,
        i && (r.innerHTML = i),
        n ? e && e.appendChild(r) : (r = c(r),
        e && r.appendTo(e)),
        r
    }, x = function(t, e) {
    ...
    t.prototype = {
        ...
        open: function(t) {
            ...
            if (!h.isOpen) {
                ...
                x("BeforeOpen"),
                h.st.showCloseBtn && (h.st.closeBtnInside ? (w(f, function(t, e, i, n) {
                    i.close_replaceWith = _(n.type)
                }),
                p += " mfp-close-btn-in") : h.wrap.append(_())),
        ...
        updateItemHTML: function() {
            ...
            var e = t.type;
            if (x("BeforeChange", [h.currItem ? h.currItem.type : "", e]),
            h.currItem = t,
            !h.currTemplate[e]) {
        ...
        appendContent: function(t, e) {
            (h.content = t) ? h.st.showCloseBtn && h.st.closeBtnInside && !0 === h.currTemplate[e] ? h.content.find(".mfp-close").length || h.content.append(_()) : h.content = t : h.content = "",
            x("BeforeAppend"),
    ...
    c.fn.magnificPopup = function(t) {
        ...
        if ("string" == typeof t)
            if ("open" === t) {
                var i, n = a ? e.data("magnificPopup") : e[0].magnificPopup, r = parseInt(arguments[1], 10) || 0;
                i = n.items ? n.items[r] : (i = e,
                ...
                var i = 0
                  ...
                  , r = function(t) {
                    ...
                    j = setInterval(function() {
                        0 < n.naturalWidth ? h._onImageHasSize(e) : (200 < i && clearInterval(j),
            ...
            getImage: function(t, e) {
                var i = 0
                  , n = function() {
                    ...
                    t.hasSize = !0,
                    t.loaded = !0,
                    x("ImageLoadComplete")) : ++i < 200 ? setTimeout(n, 100) : r())
                }
                  , r = function() {
        ...
        proto: {
            initZoom: function() {
                ...
                if (s.enabled && h.supportsTransition) {
                    var i, n, r = s.duration, o = function(t) {
                        var e = t.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image")
                          ...
                          , r = "transition";
                        return n["-webkit-" + r] = n["-moz-" + r] = n["-o-" + r] = n[r] = i,
                        e.css(n),
                        e
                    }, a = function() {
            ...
            _getOffset: function(t) {
                var e, i = (e = t ? h.currItem.img : h.st.zoom.opener(h.currItem.el || h.currItem)).offset(), n = parseInt(e.css("padding-top"), 10), r = parseInt(e.css("padding-bottom"), 10);
                ...
                A ? s["-moz-transform"] = s.transform = "translate(" + i.left + "px," + i.top + "px)" : (s.left = i.left,
                s.top = i.top),
                s
            }
        }
...
function(i, n) {
    "function" == typeof define && define.amd ? define("outlayer/item", ["ev-emitter/ev-emitter", "get-size/get-size"], function(t, e) {
        return n(i, t, e)
    }) : "object" == typeof module && module.exports ? module.exports = n(i, require("ev-emitter"), require("get-size")) : (i.Outlayer = {},
    i.Outlayer.Item = n(i, i.EvEmitter, i.getSize))
    ...
    ,
    u.transition = l.prototype[r ? "_transition" : "_nonTransition"],
...
function(r, s) {
    ...
    c.create = function(t, e) {
        var i = d(c);
        return i.defaults = s.extend({}, c.defaults),
...
function(t, e) {
    ...
    e.prototype._getItemLayoutPosition = function(t) {
        ...
        for (var n = this._getColGroup(i), r = Math.min.apply(Math, n), s = n.indexOf(r), o = {
            ...
            y: r
        }, a = r + t.size.outerHeight, l = this.cols + 1 - n.length, u = 0; u < l; u++)
            this.colYs[s + u] = a;
        return o
    }
    ,
    ...
    e.prototype._manageStamp = function(t) {
        ...
        for (var a = (this._getOption("originTop") ? i.top : i.bottom) + e.outerHeight, l = s; l <= o; l++)
          ...
          , l = function(i) {
            ...
            u(n.filtersGroupSelector).children().each(function() {
                u(this).click(function() {
                    u(n.filtersGroupSelector).children().removeClass("selected"),
                    window.location.hash = u(this).data("filter");
                    var t = [];
                    t.push("." + u(this).data("filter")),
            ...
            -1 !== u.inArray(e, s) && a(t, u("." + e)),
            u(n.filtersGroupSelector).children().removeClass("selected"),
            u(".filters li[data-filter=" + window.location.hash.replace("#", "") + "]").addClass("selected")
        };
        return this.each(function() {
            var t, i, e = u(this);
...
function(I) {
    I.fn.extend({
        slimScroll: function(S) {
            ...
            return this.each(function() {
                var n, e, r, i, s, o, a, l, u = "<div></div>", c = 30, h = !1, d = I(this);
                if (d.parent().hasClass(k.wrapperClass)) {
                    var p = d.scrollTop();
                    if (w = d.siblings("." + k.barClass),
                    y = d.siblings("." + k.railClass),
                    C(),
                    I.isPlainObject(S)) {
                        if ("height"in S && "auto" == S.height) {
                            ...
                            d.parent().css("height", f),
                            d.css("height", f)
                        } else if ("height"in S) {
                            var m = S.height;
                            d.parent().css("height", m),
                            d.css("height", m)
                        }
                        if ("scrollTo"in S)
                    ...
                    d.parent().append(w),
                    d.parent().append(y),
                    k.railDraggable && w.bind("mousedown", function(e) {
                        var i = I(document);
                        return r = !0,
                    ...
                    d.bind("touchmove", function(t) {
                        ...
                        t.originalEvent.touches.length) && (_((s - t.originalEvent.touches[0].pageY) / k.touchScrollStep, !0),
                        s = t.originalEvent.touches[0].pageY)
                    }),
                    C(),
                    "bottom" === k.start ? (w.css({
                        top: d.outerHeight() - w.outerHeight()
                    }),
                    _(0, !0)) : "top" !== k.start && (_(I(k.start).position().top, null, !0),
                    k.alwaysVisible || w.hide()),
                    v = this,
                ...
                function x(t) {
                    if (n) {
                        ...
                        I(i).closest("." + k.wrapperClass).is(d.parent()) && _(e, !0),
                ...
                function _(t, e, i) {
                    ...
                    if (e && (n = parseInt(w.css("top")) + t * parseInt(k.wheelStep) / 100 * w.outerHeight(),
                    n = Math.min(Math.max(n, 0), r),
                    n = 0 < t ? Math.ceil(n) : Math.floor(n),
                    w.css({
                        top: n + "px"
                    })),
                    n = (a = parseInt(w.css("top")) / (d.outerHeight() - w.outerHeight())) * (d[0].scrollHeight - d.outerHeight()),
                    i) {
                    ...
                    d.scrollTop(n),
                    d.trigger("slimscrolling", ~~n),
                    T(),
                    E()
                }
                function C() {
                    o = Math.max(d.outerHeight() / d[0].scrollHeight * d.outerHeight(), c),
                    w.css({
                        height: o + "px"
                    });
                ...
                function T() {
                    ...
                    a == ~~a) {
                        ...
                        h = !1;
                    l = a,
                    o >= d.outerHeight() ? h = !0 : (w.stop(!0, !0).fadeIn("fast"),
                    k.railVisible && y.stop(!0, !0).fadeIn("fast"))
                }
                function E() {
                    k.alwaysVisible || (i = setTimeout(function() {
                        k.disableFadeOut && n || e || r || (w.fadeOut("slow"),
                        y.fadeOut("slow"))
                    }, 1e3))
                }
            }),
...
function(l, i, r, a) {
    ...
    u.prototype.closest = function(i, n) {
        ...
        return this.settings.freeDrag || l.each(o, l.proxy(function(t, e) {
            return "left" === n && e - 30 < i && i < e + 30 ? r = t : "right" === n && e - s - 30 < i && i < e - s + 30 ? r = t + 1 : this.op(i, "<", e) && this.op(i, ">", o[t + 1] !== a ? o[t + 1] : e - s) && (r = "left" === n ? t + 1 : t),
            -1 === r
        }, this)),
        this.settings.loop || (this.op(i, ">", o[this.minimum()]) ? r = i = this.minimum() : this.op(i, "<", o[this.maximum()]) && (r = i = this.maximum())),
        r
    }
    ,
    ...
    u.prototype.to = function(t, e) {
        ...
        (n = (((t = i + r) - a) % o + o) % o + a) !== t && n - r <= l && 0 < n - r && (i = n - r,
        t = n,
...
function(a, s, t, e) {
    ...
    i.prototype.load = function(t) {
        ...
        !i || -1 < a.inArray(e.get(0), this._loaded) || (i.each(a.proxy(function(t, e) {
            var i, n = a(e), r = 1 < s.devicePixelRatio && n.attr("data-src-retina") || n.attr("data-src") || n.attr("data-srcset");
...
function(c, t, e, i) {
    ...
    n.prototype.fetch = function(t, e) {
        ...
        if (-1 < (n = o.match(/(http:|https:|)\/\/(player.|www.|app.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com|be\-nocookie\.com)|vzaar\.com)\/(video\/|videos\/|embed\/|channels\/.+\/|groups\/.+\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/))[3].indexOf("youtu"))
            i = "youtube";
    ...
    n.prototype.thumbnail = function(e, t) {
        var i, n, r = t.width && t.height ? "width:" + t.width + "px;height:" + t.height + "px;" : "", s = e.find("img"), o = "src", a = "", l = this._core.settings, u = function(t) {
    ...
    n.prototype.play = function(t) {
        var e, i = c(t.target).closest("." + this._core.settings.itemClass), n = this._videos[i.attr("data-video")], r = n.width || "100%", s = n.height || this._core.$stage.height();
...
function(o, t, e, i) {
    ...
    n.prototype.swap = function() {
        if (1 === this.core.settings.items && o.support.animation && o.support.transition) {
            ...
            r && n.one(o.support.animation.end, e).addClass("animated owl-animated-in").addClass(r))
        }
    }
    ,
...
function(r, t, e, s) {
    ...
    )() && (r.support.transition = new String(h("transition")),
    r.support.transition.end = i.transition.end[r.support.transition]),
    u() && (r.support.animation = new String(h("animation")),
    r.support.animation.end = i.animation.end[r.support.animation]),
    n() && (r.support.transform = new String(h("transform")),
...
$(function() {
    ...
    $(".top-menu").on("click", "a", function() {
        var t = $(window).width()
          ...
          , s = $(this).closest("li");
        $(".lnks .lnk.discover");
        return 1024 <= t && !s.hasClass("active") & 1023 < t & $("#home-card").length && (r.removeClass("active"),
        o.find(a).removeClass("animated " + l),
        $(o).hasClass("opened") && o.find(a).addClass("animated " + u),
        s.addClass("active"),
        o.addClass("opened"),
        o.find(n).removeClass("animated " + u),
        o.find(n).addClass("animated " + l),
        $(a).addClass("hidden"),
        $(n).removeClass("hidden"),
        $(n).addClass("active")),
        t < 1024 & $("#home-card").length && $("body,html").animate({
            scrollTop: i - 76
        }, 800),
        !1
    }),
    $(window).on("resize", function() {
        var t = $(window).width();
        $(window).height();
        t < 1024 ? ($(".card-inner").removeClass("hidden"),
        ...
        $(window).on("scroll", function() {
            ...
            $(".top-menu ul li a").each(function() {
                var t = $(this);
                $(t.attr("href")).offset().top - 76 <= e && ($(".top-menu ul li").removeClass("active"),
        ...
        $(".card-inner .card-wrap").attr("style", "")) : ($($(".top-menu li.active a").attr("href")).addClass("active"),
        $(".card-inner .card-wrap").slimScroll({
            height: "570px"
        }))
    }),
    ...
    $(".filter-button-group").on("change", 'input[type="radio"]', function() {
        $(this).is(":checked") && ($(".f_btn").removeClass("active"),
